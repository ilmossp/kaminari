...
function SearchBar() {
  return (
    <div className="flex bg-dark-blue-gray justify-between w-11/12 px-4  rounded-full py-2">
      <svg className="fill-cool-gray" xmlns="http://www.w3.org/2000/svg" height="24" width="24">
